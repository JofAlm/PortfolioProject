const AboutPage = () => (
  <div className="max-w-3xl mx-auto">
    ...
    <div className="bg-white p-8 rounded-lg shadow-md space-y-4 text-lg text-gray-700">
      <p>Powerful visuals, crafted with precision.</p>
      <p>
        At Audiovisium, we specialize in professional image retouching,
        photography, and creative visual solutions where AI becomes part of the
